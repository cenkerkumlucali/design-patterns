...
GarantiBank? garanti = bankCreator.Create(BankType.GarantiBank) as GarantiBank;
...
GarantiBank? garanti2 = bankCreator.Create(BankType.GarantiBank) as GarantiBank;
...
GarantiBank? garanti3 = bankCreator.Create(BankType.GarantiBank) as GarantiBank;
